...
def _build_system_prompt(session, rag_context: str) -> str:
    ...
    if session.analysis:
        ...
        return (
            ...
            "For academic papers with a DOI, include the DOI link and a Semantic Scholar search link: "
            "[Semantic Scholar](https://www.semanticscholar.org/search?q=TITLE+URL+ENCODED). "
            "For conference papers or any paper where you know the title but not the exact URL, "
            "construct a Google Scholar search link: [Title](https://scholar.google.com/scholar?q=URL+ENCODED+TITLE). "
            "NEVER mention a paper, conference, or study without a clickable link.\n\n"
            ...
            "with links. For medtech: Zimmer Biomet, Stryker, DePuy Synthes, Carpenter Technology, Solvay, "
