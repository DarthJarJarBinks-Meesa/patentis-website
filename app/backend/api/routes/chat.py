...
def _build_system_prompt(session, rag_context: str) -> str:
    ...
    if session.analysis:
        ...
        return (
            ...
            "1. SOURCES: When citing a patent, use the exact patent number from the corpus (e.g. US10123456B2). "
            "Do NOT invent patent numbers. Only cite numbers that appear in the retrieved context.\n\n"
            "2. MARKET DATA: When discussing market size, costs, or competitive landscape, include real figures.\n\n"
            "3. VENDORS: When discussing components or manufacturing, name specific vendors. "
            "For medtech: Zimmer Biomet, Stryker, DePuy Synthes, Carpenter Technology, Solvay, "
            "Nelson Labs, Toxikon, Sterigenics, Resonetics, Viant.\n\n"
            "4. FURTHER READING: End every substantive response with a 'Further Reading' section listing "
            "2-3 real, specific article or paper titles (title only, no URLs — they will be linked automatically).\n\n"
